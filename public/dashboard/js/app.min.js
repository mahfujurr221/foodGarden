...
jQuery.fn.hasDataAttr = function(a) { return $(this)[0].hasAttribute("data-" + a) }, jQuery.fn.dataAttr = function(a, b) { return $(this)[0].getAttribute("data-" + a) || b }, jQuery.fn.outerHTML = function() { var a = ""; return this.each(function() { a += $(this).prop("outerHTML") }), a }, jQuery.fn.fullHTML = function() { var a = ""; return $(this).each(function() { a += $(this).outerHTML() }), a }, jQuery.expr[":"].search = function(a, b, c) { return $(a).html().toUpperCase().indexOf(c[3].toUpperCase()) >= 0 }, jQuery.fn.scrollToEnd = function() { return $(this).scrollTop($(this).prop("scrollHeight")), this },
    function(a, b) {
        ...
        }, c.init = function() { provider.init(), c.initCorePlugins(), c.initThePlugins() }, c.call = function(a) { if ("" == a || "provider.undefined" == a) return void console.log("UNDEFINED FUNC"); for (var c = Array.prototype.slice.call(arguments, 1), d = b, e = a.split("."), f = e.pop(), g = 0; g < e.length; g++) d = d[e[g]]; try { return d[f].apply(d, c) } catch (a) { console.error(a) } }, c.loadScript = function(b, c) { a.getScript(b, c) }, c.loadStyle = function(b, c) {
            if ("" != b)
        ...
        }, c.shortcut = function(b) { a.each(b, function(a, b) { c.key(a, b) }) }, c.getDataOptions = function(b, d) {
            var e = {};
        ...
        }, c.state = function(a, b) { void 0 === localStorage.theadmin && (localStorage.theadmin = "{}"); var d = JSON.parse(localStorage.theadmin); return 0 == arguments.length ? d : 1 == arguments.length ? d[a] : void(2 == arguments.length && c.defaults.saveState && (d[a] = b, localStorage.theadmin = JSON.stringify(d))) }, c.toggleState = function(a) {
            if (c.defaults.saveState) {
                var b = c.state();
                b[a] = !b[a], localStorage.theadmin = JSON.stringify(b)
            }
        }, c.state.remove = function(a) { localStorage.removeItem(a) }, c.state.clear = function() { localStorage.clear() }, c.guid = function(a) { return void 0 == a && (a = 5), Math.random().toString(36).replace(/[^a-z]+/g, "").substr(0, a) }, c.optionToData = function(a) { return a.replace(/([A-Z])/g, "-$1").toLowerCase() }, c.dataToOption = function(a) { return a.replace(/-([a-z])/g, function(a) { return a[1].toUpperCase() }) }, c.htmlEscape = function(a) {
            var b = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;" },
    ...
    function(a, b) {
        ...
        var d, e = [],
            f = [],
            g = !0,
            h = function(a, b) { this.selector = a, this.callback = b };
        c.init = function() { $LAB.setGlobalDefaults({ BasePath: app.dir.vendor, AlwaysPreserveOrder: !0, AllowDuplicates: !1 }), c.inject(), c.observeDOM() }, c.observeDOM = function() { app.ready(function() { d = new MutationObserver(function(b) { c.inject(); for (var d = 0; d < e.length; d++) a(e[d].selector).each(e[d].callback) }), d.observe(document.body, { childList: !0, subtree: !0, attributes: !1 }) }) }, c.provide = function(b, d, f) {
            !f == !0 && (b = c.getSelector(c.list[b].selector));
            var g = [],
                i = function() { a(this).is("script") || 0 == a(this).data("init") || g.indexOf(this) == -1 && (g.push(this), a(this).each(d)) };
            ...
            if (void 0 !== b) {
                ...
                return "callback" in d && $LAB.queueWait(function() { app.call("provider." + d.callback) }), f.push(b), void $LAB.runQueue()
            }
            var i = [];
            ...
            }), g ? (c.injectExtra(), $LAB.queueWait(function() { c.callbacks = i, app.isReady() }), g = !1) : $LAB.queueWait(function() { for (var a = 0; a < i.length; a++) app.call("provider." + i[a]) }), $LAB.runQueue()
    ...
    function(a) {
        provider.initCharts = function() { provider.initPeity(), provider.initSparkline(), provider.initEasyPieChart(), provider.initChartjs() }, provider.initPeity = function() {
            a.fn.peity && provider.provide("peity", function() {
                switch (a(this).dataAttr("type", "")) {
                    ...
                    case "donut":
                        ...
                        break;
                    case "line":
                        var b = { height: 38, width: 120, delimiter: ",", min: 0, max: null, fill: app.colors.bg, stroke: app.colors.primary, strokeWidth: 1 };
                        b = a.extend(b, app.getDataOptions(a(this))), a(this).peity("line", b);
                        break;
                    case "bar":
                        var b = { height: 38, width: 120, delimiter: ",", min: 0, max: null, padding: .2, fill: app.colors.primary };
            ...
            a.fn.easyPieChart && provider.provide("easypie", function() {
                var b = { barColor: app.colors.primary, trackColor: app.colors.bg };
    ...
    function(a) {
        provider.initEditors = function() { provider.initSummernote() }, provider.initSummernote = function() {
            ...
            void 0 !== window.Quill && provider.provide("quill", function() {
                ...
                if (a.extend(b, app.getDataOptions(a(this))), void 0 !== b.toolbar) { "full" == b.toolbar.toLowerCase() && (b.modules = { toolbar: c }) }
                new Quill(a(this)[0], b)
            })
        }
    }(jQuery),
    function(a) {
        provider.initEmojies = function() { provider.initEmojione() }, provider.initEmojione = function() {
    ...
    function(a) {
        provider.initForms = function() { provider.initSelectpicker(), provider.initDatepicker(), provider.initMinicolor(), provider.initClockpicker(), provider.initMaxlength(), provider.initStrength(), provider.initTagsinput(), provider.initKnob(), provider.initNouislider(), provider.initSwitchery(), provider.initFormatter(), provider.initValidation(), provider.initWizard() }, provider.initSelectpicker = function() { a.fn.selectpicker && provider.provide("selectpicker", function() { a(this).selectpicker({ iconBase: "", tickIcon: "ti-check", style: "btn-light" }) }) }, provider.initDatepicker = function() { a.fn.datepicker && (a.fn.datepicker.defaults.multidateSeparator = ", ", provider.provide("datepicker", function() { "INPUT" == a(this).prop("tagName") ? a(this).datepicker() : a(this).datepicker({ inputs: [a(this).find("input:first"), a(this).find("input:last")] }) })) }, provider.initMinicolor = function() {
        ...
        }, provider.initClockpicker = function() { a.fn.clockpicker && provider.provide("clockpicker", function() { a(this).clockpicker({ donetext: "Done" }) }) }, provider.initMaxlength = function() {
            a.fn.maxlength && provider.provide("maxlength", function() {
                var b = { warningClass: "badge badge-warning", limitReachedClass: "badge badge-danger", placement: "bottom-right-inside" };
            ...
            a.fn.pwstrength && provider.provide("pwstrength", function() {
                var b = { ui: { bootstrap4: !0, progressBarEmptyPercentage: 0, showVerdicts: !1 }, common: { usernameField: a(this).dataAttr("username", "#username") } };
                if (a(this).pwstrength(b), a(this).add(a(this).next()).wrapAll('<div class="pwstrength"></div>'), a(this).is('[data-vertical="true"]')) {
                    var c = a(this).outerHeight() - 10,
                        d = -c / 2 + 7,
                        e = c / 2 + 4;
                    a(this).next(".progress").css({ width: c, right: d, bottom: e })
                }
            })
        }, provider.initTagsinput = function() { a.fn.tagsinput && provider.provide("tagsinput", function() { a(this).tagsinput() }) }, provider.initKnob = function() {
            a.fn.knob && provider.provide("knob", function() {
                var b = { thickness: .1, width: 120, height: 120, fgColor: app.colors.primary, bgColor: app.colors.bg };
            ...
            void 0 !== window.noUiSlider && provider.provide("slider", function(b, c) {
                var d = { range: { min: Number(a(this).dataAttr("min", 0)), max: Number(a(this).dataAttr("max", 100)) }, step: 1, start: a(this).dataAttr("value", 0), connect: "lower", margin: 0, limit: 100, orientation: "horizontal", direction: "ltr", tooltips: !1, animate: !0, behaviour: "tap", format: { to: function(a) { return a }, from: function(a) { return a } } };
                ...
                }), c.noUiSlider.on("change", function(b, d) { a(c).hasDataAttr("on-change") && app.call(a(c).data("on-change"), b) })
            })
        }, provider.initSwitchery = function() {
            void 0 !== window.Switchery && provider.provide("switchery", function() {
                var b = { color: app.colors.primary, speed: "0.5s" };
            ...
            a.fn.formatter && provider.provide("formatter", function() {
                var b = { pattern: a(this).data("format"), persistent: a(this).dataAttr("persistent", !0) };
                a(this).formatter(b)
            })
        }, provider.initValidation = function() {
            a.fn.validator && (a.fn.validator.Constructor.FOCUS_OFFSET = 100, provider.provide("validation", function() { a(this).validator() }), a(document).on("click", '[data-perform="validation"]', function() {
            ...
            a.fn.bootstrapWizard && provider.provide("wizard", function() {
                ...
                b.bootstrapWizard({
                    ...
                    onTabClick: function(a, c, d) { if (!b.is('[data-navigateable="true"]')) return !1 },
                    ...
                    onBack: function(a, c, d) { b.hasDataAttr("on-back") && app.call(b.data("on-back"), a, c, d) },
                    onPrevious: function(a, c, d) { b.hasDataAttr("on-previous") && app.call(b.data("on-previous"), a, c, d) },
                    ...
                    onFinish: function(a, e, f) {
                        var g = d.eq(f),
                            h = g.find('[data-provide="validation"]').addBack('[data-provide="validation"]');
                        if (h.length && (h.validator("validate"), h.find(".has-error").length)) return h.closest("form").one("submit", function(a) { a.preventDefault() }), !1;
    ...
    function(a) { provider.initIcons = function() { provider.initI8icons() }, provider.initI8icons = function() { provider.provide("iconI8", function() { a(document).i8icons(function(a) { a.defaultIconSetUrl(app.dir.vendor + "i8-icon/i8-color-icons.svg") }) }) } }(jQuery),
    function(a) { provider.initMaps = function() {}, provider.initMap = function() {}, provider.initMapael = function() {} }(jQuery),
    function(a) { provider.initTables = function() { provider.initBootstrapTable() }, provider.initBootstrapTable = function() { a.fn.bootstrapTable && (jQuery.fn.bootstrapTable.defaults.classes = "table", provider.provide("table", function() { a(this).bootstrapTable() }), a(".fixed-table-body").perfectScrollbar()) }, provider.initJsGrid = function() { a.fn.jsGrid }, provider.initDatatables = function() { a.fn.DataTable && provider.provide("datatables", function() { a(this).DataTable() }) } }(jQuery),
    function(a) {
        provider.initUIs = function() { provider.initSweetalert2(), provider.initAnimsition(), provider.initLity(), provider.initSortable(), provider.initShepherd(), provider.initFilterizr() }, provider.initSweetalert2 = function() { void 0 !== window.swal && sweetAlert.setDefaults({ confirmButtonClass: "btn btn-bold btn-primary", cancelButtonClass: "btn btn-bold btn-secondary", buttonsStyling: !1 }) }, provider.initAnimsition = function() { a.fn.animsition && provider.provide(".animsition", function() { a(this).animsition({ linkElement: '[data-provide~="animsition"], .animsition-link', loadingInner: "" }) }, !0) }, provider.initLity = function() { void 0 !== window.lity && a(document).on("click", '[data-provide~="lity"]', lity) }, provider.initSortable = function() {
            void 0 !== window.sortable && provider.provide("sortable", function(b, c) {
                sortable(c, { dragImage: null, forcePlaceholderSize: !0, items: a(this).dataAttr("items", null), handle: a(this).dataAttr("sortable-handle", null) }), sortable(a(this))[0].addEventListener("sortupdate", function(b) {
        ...
        }, provider.initShepherd = function() { void 0 !== window.Shepherd && (Shepherd.on("start", function() { a("body").prepend('<div class="app-backdrop backdrop-tour"></div>') }), Shepherd.on("inactive", function() { a(".app-backdrop.backdrop-tour").remove() })) }, provider.initShuffle = function() {
            if (void 0 !== window.Shuffle) {
                ...
                b.options.itemSelector = '[data-shuffle="item"]', b.options.sizer = '[data-shuffle="sizer"]', b.options.delimeter = ",", b.options.speed = 500, provider.provide("shuffle", function() {
                    ...
                    }), a(this).imagesLoaded(function() { e.layout() })
                })
            }
            ...
            a.fn.photoSwipe && provider.provide("photoswipe", function() {
                var b = a(this),
                    ...
                    d = {},
                    e = { escKey: "bool", loop: "bool", pinchToClose: "bool", arrowKeys: "bool", history: "bool", modal: "bool", index: "num", bgOpacity: "num", timeToIdle: "num", spacing: "num", spacing: "array" };
                d = a.extend(d, app.getDataOptions(a(this), e));
                var f = { close: function() { b.hasDataAttr("on-close") && app.call(b.data("on-close")) } };
            ...
            void 0 !== window.Swiper && provider.provide("swiper", function() {
                var b = { autoplay: 0, speed: 1e3, loop: !0, breakpoints: { 480: { slidesPerView: 1 } } },
                    c = a(this);
    ...
    function(a) {
        provider.initUploads = function() { provider.initDropify(), provider.initDropzone() }, provider.initDropify = function() { a.fn.dropify && provider.provide("dropify", function() { a(this).dropify() }) }, provider.initDropzone = function() {
    ...
    function(a) {
        provider.initMiscs = function() { provider.initJustifiedGallery() }, provider.initFullcalendar = function() { a.fn.fullCalendar }, provider.initJustifiedGallery = function() {
            a.fn.justifiedGallery && provider.provide("justified", function() {
                var b = { captions: !1, cssAnimation: !0, imagesAnimationDuration: 500 };
                a.extend(b, app.getDataOptions(a(this))), a(this).justifiedGallery(b)
            })
        }, provider.initAos = function() { void 0 !== window.AOS && provider.provide("aos", function() { AOS.init({ duration: 800 }) }) }, provider.initTyped = function() {
            void 0 !== window.Typed && provider.provide("typed", function() {
                var b = a(this).data("type").split("|"),
                    c = { strings: b, typeSpeed: 50, backSpeed: 30, loop: !0 };
    ...
    function(a) {
        app.modaler = function(b) {
            var c = a.extend({}, app.defaults.modaler, b),
                d = function() { c.onShow && a("#" + e).on("show.bs.modal", function(a) { app.call(c.onShow, a) }), c.onShown && a("#" + e).on("shown.bs.modal", function(a) { app.call(c.onShown, a) }), c.onHide && a("#" + e).on("hide.bs.modal", function(a) { app.call(c.onHide, a) }), c.onHidden && a("#" + e).on("hidden.bs.modal", function(a) { app.call(c.onHidden, a) }), a("#" + e).find('[data-perform="confirm"]').on("click", function() { if (null != c.onConfirm) return a.isFunction(c.onConfirm) ? void c.onConfirm(a("#" + e)) : void(c.onConfirm.substring && app.call(c.onConfirm, a("#" + e))) }), a("#" + e).find('[data-perform="cancel"]').on("click", function() { if (null != c.onCancel) return a.isFunction(c.onCancel) ? void c.onCancel(a("#" + e)) : void(c.onCancel.substring && app.call(c.onCancel, a("#" + e))) }) };
            if (c.modalId) return void a("#" + c.modalId).modal("show");
            var e = "modal-" + app.guid();
            if (c.isModal) a("<div>").load(c.url, function() { a("body").append(a(this).find(".modal").attr("id", e).outerHTML()), a("#" + e).modal("show"), c.autoDestroy ? a("#" + e).on("hidden.bs.modal", function() { a("#" + e).remove() }) : a(c.this).attr("data-modal-id", e), d() });
            else {
                switch (c.size) {
                    case "sm":
                        c.size = "modal-sm";
                ...
                a("body").append(h), a("#" + e).modal("show"), c.autoDestroy ? a("#" + e).on("hidden.bs.modal", function() { a("#" + e).remove() }) : a(c.this).attr("data-modal-id", e), c.url ? a("#" + e).find(".modal-body").load(c.url, function() { d() }) : c.html ? (a("#" + e).find(".modal-body").html(c.html), d()) : c.target && (a("#" + e).find(".modal-body").html(a(c.target).html()), d())
            }
        }, a(document).on("click", '[data-provide~="modaler"]', function() { app.modaler(app.getDataOptions(a(this))) })
    }(jQuery),
    function(a) {
        app.toast = function(b, c) {
            ...
            var e = a(".toast"),
                f = "";
            "" != d.actionTitle && (f = '<a class="text-' + d.actionColor + '" href="' + d.actionUrl + '">' + d.actionTitle + "</a>"), e.hasClass("reveal") && e.finish().queue(function(b) { a(this).removeClass("reveal"), b() }).delay(300), e.delay(1).queue(function(c) { a(this).find(".text").text(b).next(".action").html(f), a(this).addClass("reveal"), c() }).delay(d.duration).queue(function(b) { a(this).removeClass("reveal"), b() })
    ...
    function(a, b) {
        var c = {};
        c.init = function() { a(".aside-body").perfectScrollbar(), a(document).on("click", ".aside-toggler", function() { c.toggle() }) }, c.toggle = function() { a("body").toggleClass("aside-open") }, c.open = function() { a("body").addClass("aside-open") }, c.close = function() { a("body").removeClass("side-open") }, b.aside = c
    }(jQuery, window),
    function(a, b) {
        var c = {};
        c.init = function() { a(".topbar .list-group").each(function() { a(this).height() > 265 && a(this).perfectScrollbar() }) }, c.toggleFix = function() { a(".topbar").toggleClass("topbar-unfix"), app.toggleState("topbar.fixed") }, c.fix = function() { a(".topbar").removeClass("topbar-unfix"), app.state("topbar.fixed", !0) }, c.unfix = function() { a(".topbar").addClass("topbar-unfix"), app.state("topbar.fixed", !1) }, c.isFixed = function() { return !a(".topbar.topbar-unfix").length }, b.topbar = c
    }(jQuery, window),
    function(a, b) {
        var c = {};
        c.init = function() {
            a(".sidebar-navigation").perfectScrollbar(), a(document).on("click", ".sidebar-toggler", function() { c.open() }), a(document).on("click", ".backdrop-sidebar", function() { c.close() }), a(document).on("click", ".sidebar .menu-link", function() {
                var b = a(this).next(".menu-submenu");
                if (!(b.length < 1)) {
                    if (b.is(":visible")) return b.slideUp(function() { a(".sidebar .menu-item.open").removeClass("open") }), void a(this).removeClass("open");
                    a(".sidebar .menu-submenu:visible").slideUp(), a(".sidebar .menu-link").removeClass("open"), b.slideToggle(function() { a(".sidebar .menu-item.open").removeClass("open") }), a(this).addClass("open")
                }
            }), a(document).on("click", ".sidebar-toggle-fold", function() { c.toggleFold() })
        }, c.toggleFold = function() { a("body").toggleClass("sidebar-folded"), app.toggleState("sidebar.folded") }, c.fold = function() { a("body").addClass("sidebar-folded"), app.state("sidebar.folded", !0) }, c.unfold = function() { a("body").removeClass("sidebar-folded"), app.state("sidebar.folded", !1) }, c.open = function() { a("body").addClass("sidebar-open").prepend('<div class="app-backdrop backdrop-sidebar"></div>') }, c.close = function() { a("body").removeClass("sidebar-open"), a(".backdrop-sidebar").remove() }, b.sidebar = c
    }(jQuery, window),
    function(a, b) {
        var c = {};
        c.init = function() {
            a(".quickview-body").perfectScrollbar(), a(document).on("shown.bs.tab", '.quickview-header a[data-toggle="tab"]', function(b) { a(this).closest(".quickview").find(".quickview-body").perfectScrollbar("update") }), a(document).on("click", '[data-dismiss="quickview"]', function() { c.close(a(this).closest(".quickview")) }), a(document).on("click", '[data-toggle="quickview"]', function(b) {
                b.preventDefault();
        ...
        }, c.toggle = function(b) { a(b).hasClass("reveal") ? c.close(b) : c.open(b) }, c.open = function(b) {
            var c = a(b);
            c.hasDataAttr("url") && "true" !== c.data("url-has-loaded") && c.load(c.data("url"), function() { a(".quickview-body").perfectScrollbar(), c.hasDataAttr("always-reload") && "true" === c.data("always-reload") || c.data("url-has-loaded", "true") }), c.addClass("reveal").not(".backdrop-remove").after('<div class="app-backdrop backdrop-quickview" data-target="' + b + '"></div>')
        }, c.close = function(b) { a(b).removeClass("reveal"), a(".backdrop-quickview").remove() }, b.quickview = c
    }(jQuery, window),
    function(a, b) {
        var c = {},
            d = [],
            e = [];
        c.init = function() {
            a(".dock-body").perfectScrollbar({ wheelPropagation: !1 }), a(document).on("click", '[data-toggle="dock"]', function(b) {
                b.preventDefault();
                var d = app.getTarget(a(this));
                c.toggle(d, a(this))
            }), a(document).on("click", '[data-dock="close"], [data-dismiss="dock"]', function() { c.close(a(this).closest(".dock")) }), a(document).on("click", '[data-dock="minimize"], .dock.minimize .dock-header', function() { c.toggleMinimize(a(this).closest(".dock")) }), a(document).on("click", '[data-dock="maximize"]', function() { c.toggleMaximize(a(this).closest(".dock")) }), a(document).on("click", ".dock", function() {}), a(document).on("click", ".dock .close", function() {
                var b = a(this).closest(".dock");
                b.close(b)
            })
        }, c.toggle = function(b, d) { a(b).hasClass("reveal") ? c.close(b) : c.open(b, d) }, c.open = function(b, d) {
            var e = a(b),
                f = e.find(".dock-body");
    ...
    function(a, b) {
        ...
        c.init = function() {
            ...
            a("body").hasClass("topbar-toggleable-xs") ? b = app.breakpoint.xs : a("body").hasClass("topbar-toggleable-sm") ? b = app.breakpoint.sm : a("body").hasClass("topbar-toggleable-md") && (b = app.breakpoint.md), a(document).width() > b || a(document).on("click", ".topbar .menu-link", function() {
                var b = a(this).next(".menu-submenu");
                if (!(b.length < 1)) {
                    if (b.is(":visible")) return b.slideUp(function() { a(".topbar .menu-item.open").removeClass("open") }), void a(this).removeClass("open");
                    a(".topbar .menu-submenu:visible").slideUp(), a(".topbar .menu-link").removeClass("open"), b.slideDown(function() { a(".topbar .menu-item.open").removeClass("open") }), a(this).addClass("open")
                }
            })
        }, c.open = function() { a("body").addClass("topbar-menu-open").find(".topbar").prepend('<div class="app-backdrop backdrop-topbar-menu"></div>') }, c.close = function() { a("body").removeClass("topbar-menu-open"), a(".backdrop-topbar-menu").remove() }, b.topbar_menu = c
    }(jQuery, window),
    function(a, b) {
        var c = {};
        c.init = function() {
        ...
        }, c.toggle = function(b) { a(b).hasClass("reveal") ? c.close(b) : c.open(b) }, c.close = function(b) { a(b).removeClass("reveal"), a("body").removeClass("no-scroll") }, c.open = function(b) { a(b).addClass("reveal"), a(b).find(".lookup-form input").focus(), a("body").addClass("no-scroll") }, b.lookup = c
    }(jQuery, window),
    function(a, b) {
        var c = {};
        c.init = function() {
            a(document).on("click", ".card-btn-close", function() { a(this).parents(".card").fadeOut(600, function() { 1 == a(this).parent().children().length ? a(this).parent().remove() : a(this).remove() }) }), a(document).on("click", ".card-btn-slide", function() { a(this).toggleClass("rotate-180").parents(".card").find(".card-content").slideToggle() }), a(document).on("click", ".card-btn-maximize", function() { a(this).parents(".card").toggleClass("card-maximize").removeClass("card-fullscreen") }), a(document).on("click", ".card-btn-fullscreen", function() { a(this).parents(".card").toggleClass("card-fullscreen").removeClass("card-maximize") }), a(document).on("click", ".card-btn-reload", function(b) {
                b.preventDefault();
                var c = a(this).attr("href"),
                    d = a(this).parents(".card");
                "#" != c && (d.find(".card-loading").addClass("reveal"), d.find(".card-content").load(c, function() { d.find(".card-loading").removeClass("reveal") }))
            }), a(".card-carousel").each(function() {
                var b = !1;
                a(this).hasDataAttr("ride") && (b = 5e3), a(this).carousel({ interval: b })
            }), a(document).on("click", ".card-btn-next", function() { a(this).parents(".card-carousel").carousel("next") }), a(document).on("click", ".card-btn-prev", function() { a(this).parents(".card-carousel").carousel("prev") }), a(document).on("click", ".card-carousel .carousel-indicators li", function() { a(this).parents(".card-carousel").carousel(a(this).data("slide-to")), a(this).parent().find(".active").removeClass("active"), a(this).addClass("active") })
    ...
    function(a) {
        app.initCorePlugins = function() {
            provider.initAnimsition(), Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1, a('[data-provide~="tooltip"]').each(function() {
                var b = "";
                a(this).hasDataAttr("tooltip-color") && (b = " tooltip-" + a(this).data("tooltip-color")), a(this).tooltip({ container: "body", trigger: "hover", template: '<div class="tooltip' + b + '" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>' })
            }), a('[data-provide~="popover"]').popover({ container: "body" }), a(".modal-right .modal-body, .modal-left .modal-body").perfectScrollbar(), a(".scrollable").perfectScrollbar({ wheelPropagation: !1, wheelSpeed: .5 }), a(document).on("click", ".no-collapsing", function(a) { a.stopPropagation() })
        }, app.initThePlugins = function() {
            function b(a) { a.parent(".input-group-input").length ? a.parent(".input-group-input").addClass("do-float") : a.closest(".form-group").addClass("do-float") }

            function c(a) { a.parent(".input-group-input").length ? a.parent(".input-group-input").removeClass("do-float") : a.closest(".form-group").removeClass("do-float") }
            a(document).on("click", 'a[href="#"]', function(a) { a.preventDefault() }), a(document).on("click", '[data-provide~="scrollup"]', function() { return a("html, body").animate({ scrollTop: 0 }, 600), !1 }), a(document).on("click", ".nav-tabs .dropdown-item", function() { a(this).siblings(".dropdown-item.active").removeClass("active") }), a(document).on("click", ".file-browser", function() {
                var b = a(this);
                if (b.hasClass("form-control")) setTimeout(function() { b.closest(".file-group").find('[type="file"]').trigger("click") }, 300);
                else {
                    var c = b.closest(".file-group").find('[type="file"]');
                    c.on("click", function(a) { a.stopPropagation() }), c.trigger("click")
                }
            ...
            a(document).on("click", d, function() { a(this).find(".form-control").focus() }), a(document).on("focusin", d, function() { a(this).addClass("focused") }), a(document).on("focusout", d, function() { a(this).removeClass("focused") }), a(document).on("focus", ".form-type-material .form-control:not(.bootstrap-select)", function() { b(a(this)) }), a(document).on("focusout", ".form-type-material .form-control:not(.bootstrap-select)", function() { "" === a(this).val() && c(a(this)) }), a(".form-type-material .form-control").each(function() {
                ...
                a('[data-provide~="sticker"]').each(function() {
                    ...
                    var h = { left: a(this).offset().left, width: f, top: g };
                ...
                a(this).closest("table").find("tr td:nth-child(" + (c + 1) + ") :checkbox").each(function() { a(this).prop("checked", d), d ? a(this).closest("tr").addClass("active") : a(this).closest("tr").removeClass("active") })
            }), a(document).on("change", '[data-provide~="selectall"] tbody .custom-checkbox :checkbox', function() { a(this).prop("checked") ? a(this).closest("tr").addClass("active") : a(this).closest("tr").removeClass("active") }), a(document).on("click", '.table[data-provide~="selectable"] tbody tr', function() {
                ...
                a(b).find('.media-list-body .custom-checkbox [type="checkbox"]').each(function() { a(this).prop("checked", c), c ? a(this).closest(".media").addClass("active") : a(this).closest(".media").removeClass("active") })
            }), a(document).on("change", '[data-provide~="selectall"] .media .custom-checkbox input', function() { a(this).prop("checked") ? a(this).closest(".media").addClass("active") : a(this).closest(".media").removeClass("active") }), a(document).on("click", '.media[data-provide~="selectable"], .media-list[data-provide~="selectable"] .media:not(.media-list-header):not(.media-list-footer)', function() {
                ...
                var b = a(this);
                setTimeout(function() { b.scrollTop(0).css("height", b.prop("scrollHeight") + "px") }, 0)
            }), a(document).on("click", ".code-toggler .btn", function() { a(this).closest(".code").find("pre").slideToggle() }), a(document).on("change mousemove", ".input-range input", function() { a(this).closest(".input-range").find(".value").text(a(this).val()) }), a(document).on("click", ".avatar-pill .close", function() { a(this).closest(".avatar").fadeOut(function() { a(this).remove() }) }), a(document).on("click", '[data-provide~="more-avatar"]', function() {
                ...
                j.animate({ r: a(g).outerWidth() }, { duration: 400, step: function(a) { j.attr("r", a) }, complete: function() { j.fadeOut("fast") } })
            }), a(document).on("click", '[data-dismiss="callout"]', function() { a(this).closest(".callout").fadeOut(function() { a(this).remove() }) }), a(document).on("click", '[data-dismiss="tab"]', function() { a(this).closest(".nav-item").fadeOut(function() { a(this).remove() }) });
            var e = function(a) { a.find("input:checked").length ? a.attr("data-has-rate", "true") : a.attr("data-has-rate", "false") };
            a(document).on("click", ".rating-remove", function() { a(this).closest(".rating").find("input").prop("checked", !1), e(a(this).closest(".rating")) }), a(".rating").each(function() { e(a(this)) }), a(document).on("change", ".rating input", function() { e(a(this).closest(".rating")) }), a(document).on("click", '[data-provide~="loader"]', function(b) {
                b.preventDefault();
                var c = app.getTarget(a(this)),
                    d = app.getURL(a(this));
                ...
                a(c).load(d)
            }), a(document).on("click", ".lookup-textual .lookup-placeholder", function() { a(this).closest(".lookup").find("input").focus() }), a(document).on("focus blur keyup", ".lookup-textual input", function() { var b = a(this).closest(".lookup").find(".lookup-placeholder"); "" == a(this).val() ? b.css("display", "inline-block") : b.css("display", "none") }), a(document).on("keyup", ".lookup-fullscreen[data-url] .lookup-form input", function() {
                var b = a(this).val(),
                    c = a(this).closest(".lookup-fullscreen"),
                    d = c.data("url");
                c.find(".lookup-results").load(d, { s: b })
            })
        }
    }(jQuery),
    function(a) { app.init(), topbar.init(), sidebar.init(), topbar_menu.init(), quickview.init(), dock.init(), aside.init(), lookup.init(), cards.init(), app.isReady() }(jQuery);