...
<div class="col-12">
    <div class="card">
        <h4 class="card-title">
            <strong>Address</strong>
            <a href="{{ route('customer.add_address') }}" class="edit btn btn-outline btn-primary pull-right"
        ...
        <div class="card-body card-body-soft">
                ...
                <table class="table table-soft">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->name }}</td>
                            <td>
                                <a class="btn btn-primary  text-white" data-target="#editModal-{{$data->id}}"
                                    data-toggle="modal">
                        ...
                        <form action="{{route('customer.update_address', $data->id)}}" method="POST">
                            @csrf
            ...
            <div class="alert alert-danger" role="alert">
                <strong>You have no address</strong>
            </div>
            @endif
        </div>
    </div>
